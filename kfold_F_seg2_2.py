...
data2=pd.read_csv("D:/鬼怒川/データセット/データセットy/k_split/test/std/F_seg2_2_1.csv", encoding="shift-jis")
...
data2=pd.read_csv("D:/鬼怒川/データセット/データセットy/k_split/test/std/F_seg2_2_2.csv", encoding="shift-jis")
...
data2=pd.read_csv("D:/鬼怒川/データセット/データセットy/k_split/test/std/F_seg2_2_3.csv", encoding="shift-jis")
...
data2=pd.read_csv("D:/鬼怒川/データセット/データセットy/k_split/test/std/F_seg2_2_4.csv", encoding="shift-jis")
...
data2=pd.read_csv("D:/鬼怒川/データセット/データセットy/k_split/test/std/F_seg2_2_5.csv", encoding="shift-jis")
...
#df_p=df_p.T
#df_F=df_F.T
df_p.to_csv("D:/鬼怒川/データセット/データセットy/k_split/result/F_para_seg2_2.csv",encoding="shift-jis",index=False,header=False)
df_F.to_csv("D:/鬼怒川/データセット/データセットy/k_split/result/F_f1_seg2_2.csv",encoding="shift-jis",index=False,header=False)