...
data1=pd.read_csv("./5_split/train/N_seg1_1.csv", encoding="shift-jis")
data2=pd.read_csv("./5_split/test/N_seg1_1.csv", encoding="shift-jis")
...
logistics(['DisWater',"RHeight"],"modelA","Segment1","Normal")
logistics(['DisWater',"ShieldsP"],"modelB","Segment1","Normal")
logistics(['DisWater',"RHeight","Vegetation"],"modelC","Segment1","Normal")
logistics(['DisWater',"ShieldsP","Vegetation"],"modelD","Segment1","Normal")

data1=pd.read_csv("./5_split/train/N_seg1_2.csv", encoding="shift-jis")
data2=pd.read_csv("./5_split/test/N_seg1_2.csv", encoding="shift-jis")
...
data1=pd.read_csv("./5_split/train/N_seg1_3.csv", encoding="shift-jis")
data2=pd.read_csv("./5_split/test/N_seg1_3.csv", encoding="shift-jis")
...
data1=pd.read_csv("./5_split/train/N_seg1_4.csv", encoding="shift-jis")
data2=pd.read_csv("./5_split/test/N_seg1_4.csv", encoding="shift-jis")
...
data1=pd.read_csv("./5_split/train/N_seg1_5.csv", encoding="shift-jis")
data2=pd.read_csv("./5_split/test/N_seg1_5.csv", encoding="shift-jis")
...
#df_p=df_p.T
#df_F=df_F.T
df_p.to_csv("./5_split/result/N_para_seg1.csv",encoding="shift-jis",index=False,header=False)
df_F.to_csv("./5_split/result/N_f1_seg1.csv",encoding="shift-jis",index=False,header=False)
