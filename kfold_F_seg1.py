# -*- coding: utf-8 -*-
"""
Created on Fri Jun  2 11:28:34 2023
...
#k_split1
data1=pd.read_csv("./5_split/train/F_seg1_1.csv", encoding="shift-jis")
data2=pd.read_csv("./5_split/test/F_seg1_1.csv", encoding="shift-jis")
...
df=data1
df2=data2
logistics(['DisWater',"RHeight"],"modelA","Segment1","Flood")
logistics(['DisWater',"ShieldsP"],"modelB","Segment1","Flood")
logistics(['DisWater',"RHeight","Vegetation"],"modelC","Segment1","Flood")
logistics(['DisWater',"ShieldsP","Vegetation"],"modelD","Segment1","Flood")

#k_split2
data1=pd.read_csv("./5_split/train/F_seg1_2.csv", encoding="shift-jis")
data2=pd.read_csv("./5_split/test/F_seg1_2.csv", encoding="shift-jis")
...
#k_split3
data1=pd.read_csv("./5_split/train/F_seg1_3.csv", encoding="shift-jis")
data2=pd.read_csv("./5_split/test/F_seg1_3.csv", encoding="shift-jis")
...
#k_split4
data1=pd.read_csv("./5_split/train/F_seg1_4.csv", encoding="shift-jis")
data2=pd.read_csv("./5_split/test/F_seg1_4.csv", encoding="shift-jis")
...
#k_split5
data1=pd.read_csv("./5_split/train/F_seg1_5.csv", encoding="shift-jis")
data2=pd.read_csv("./5_split/test/F_seg1_5.csv", encoding="shift-jis")
...
#df_p=df_p.T
#df_F=df_F.T
df_p.to_csv("./5_split/result/F_para_seg1.csv",encoding="shift-jis",index=False,header=False)
df_F.to_csv("./5_split/result/F_f1_seg1.csv",encoding="shift-jis",index=False,header=False)
