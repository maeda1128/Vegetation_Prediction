# -*- coding: utf-8 -*-
"""
Created on Fri Jun  2 12:45:43 2023
...
#k_split1
data1=pd.read_csv("./5_split/train/N_seg2_2_1.csv", encoding="shift-jis")
data2=pd.read_csv("./5_split/test/N_seg2_2_1.csv", encoding="shift-jis")
...
df=data1
df2=data2
logistics(['DisWater',"RHeight"],"modelA","Segment2_2","Normal")
logistics(['DisWater',"ShieldsP"],"modelB","Segment2_2","Normal")
logistics(['DisWater',"RHeight","Vegetation"],"modelC","Segment2_2","Normal")
logistics(['DisWater',"ShieldsP","Vegetation"],"modelD","Segment2_2","Normal")

#k_split2
data1=pd.read_csv("./5_split/train/N_seg2_2_2.csv", encoding="shift-jis")
data2=pd.read_csv("./5_split/test/N_seg2_2_2.csv", encoding="shift-jis")
...
#k_split3
data1=pd.read_csv("./5_split/train/N_seg2_2_3.csv", encoding="shift-jis")
data2=pd.read_csv("./5_split/test/N_seg2_2_3.csv", encoding="shift-jis")
...
#k_split4
data1=pd.read_csv("./5_split/train/N_seg2_2_4.csv", encoding="shift-jis")
data2=pd.read_csv("./5_split/test/N_seg2_2_4.csv", encoding="shift-jis")
...
logistics(['DisWater',"RHeight"],"modelA","Segment2_2","Normal")
logistics(['DisWater',"ShieldsP"],"modelB","Segment2_2","Normal")
logistics(['DisWater',"RHeight","Vegetation"],"modelC","Segment2_1","Normal")
logistics(['DisWater',"ShieldsP","Vegetation"],"modelD","Segment2_1","Normal")

#k_split5
data1=pd.read_csv("./5_split/train/N_seg2_2_5.csv", encoding="shift-jis")
data2=pd.read_csv("./5_split/test/N_seg2_2_5.csv", encoding="shift-jis")
...
#df_p=df_p.T
#df_F=df_F.T
df_p.to_csv("./5_split/result/N_para_seg2_2.csv",encoding="shift-jis",index=False,header=False)
df_F.to_csv("./5_split/result/N_f1_seg2_2.csv",encoding="shift-jis",index=False,header=False)
